...
#Salva12
    def __init__(self):
        ...
        self.spider = Obj('assets/spider1.png', random.randint(0, 300), -50)
        self.flower = Obj('assets/florwer1.png', random.randint(0, 300), - 50)
        self.change_scane = False
