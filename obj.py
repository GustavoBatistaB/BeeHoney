...
class Obj:
    ...
    def anim(self, image, tick, frame):
        self.tick += 1
        if self.tick == tick:
            self.tick = 0
            self.frame += 1
...
class Bee(Obj):
    def __init__(self, image, x, y):
        ...
        self.sound_block = pygame.mixer.Sound('assets/sounds/bateu.wav')
        self.life = 3
        self.pts = 0
...
class Text:
    ...
    def __init__(self, size, text):
        ...
        self.render = self.font.render(text, False, (17, 84, 69))

    def draw(self, window, x, y):
        window.blit(self.render, (x, y))

    def update_text(self, update):
        self.render = self.font.render(update, False, (17, 84, 69))
